...
abstract class $WeatherCopyWith<$Res> {
  ...
  @useResult
  $Res call({String cityName, List<Forecast> forecast});
}
...
class _$WeatherImpl implements _Weather {
  const _$WeatherImpl(
      {required this.cityName, required final List<Forecast> forecast})
      : _forecast = forecast;
  ...
  @override
  String toString() {
    return 'Weather(cityName: $cityName, forecast: $forecast)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, cityName, const DeepCollectionEquality().hash(_forecast));
...
abstract class _Weather implements Weather {
  const factory _Weather(
      ...
      required final List<Forecast> forecast}) = _$WeatherImpl;
